...
export const defaultEntries: TimeLine_01Entry[] = [
  {
    icon: ChevronsRight,
    title: "Humworld Services, Chennai",
    description: "Web Developer",
    subDescription: "Mar 2025 - Present",
    items: [
      "Built and enhanced telehealth application using JavaScript and healthcare workflows.",
  ...
  {
    icon: ChevronsRight,
    title: "Closerlook Digital, Coimbatore",
    description: "Web Developer",
    subDescription: "May 2022 - Mar 2025",
    items: [
      "Developed scalable web applications, admin portals, and reusable UI components using React.js, JavaScript, HTML5, CSS3, and REST APIs.",
      "Built configuration management tools and CRUD-based workflows, enabling seamless integration between frontend applications and backend services.",
      "Developed real-time analytics dashboards and React-based POS solutions for reporting, inventory tracking, and business operations.",
      "Implemented secure authentication and authorization mechanisms, including Two-Factor Authentication (2FA), access token management, and role-based access control.",
      "Developed and maintained WordPress/WooCommerce websites, implementing custom PHP functionality, payment integrations, accessibility compliance, performance optimization, and website migrations."
    ],
    image:
      "",
    button: {
  ...
  },
  {
    ...
    subDescription: "Oct 2021 - Apr 2022",
    items: [
      "Assisted in developing and maintaining WordPress websites, implementing responsive designs, content updates, and plugin customizations.",
      "Supported website deployment, hosting management, SSL installation, DNS configuration, and performance optimization activities.",
      "Collaborated with senior developers on WooCommerce enhancements, website migrations, bug fixes, and client support requests.",
      "Worked on Newsletters, Email leads with Mailchimp, Vtiger CRM etc",
    ],
    image:
      "",
    button: {
  ...
  return (
    <section className="py-12">
      <div className="container">
        <div className="mx-auto space-y-16 md:mt-24 md:space-y-24">
          {entries.map((entry, index) => {
            ...
            return (
              ...
              >
                {/* Sticky meta column */}
                <div className="top-8 flex h-min w-90 shrink-0 items-center gap-4 md:sticky">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-3xl font-bold tracking-tight md:text-3xl">
                        {entry.title}
                      </span>
                    </div>
                  </div>
