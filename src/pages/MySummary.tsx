...
export default function AboutMeSummary() {
  ...
  return (
    <div className="bg-zinc-20 flex items-center justify-center p-6 md:p-12 relative overflow-hidden">
      {/* Background Ambience */}
        ...
        {/* <div className="flex justify-center mb-8">
          <div className="bg-white border border-gray-200 shadow-sm px-4 py-1.5 rounded-full flex items-center gap-2">
            ...
            <span className="text-xs font-bold tracking-widest text-gray-500 uppercase">
              Checkout the Interactive Bio
            </span>
          </div>
        </div> */}

        {/* Main Content */}
        <div className="bg-white/70 backdrop-blur-xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-8 md:p-10">
          <HyperTextParagraph
            text={bio}
            highlightWords={triggers}
            className="text-2xl md:text-2xl text-gray-800 font-normal leading-[1.6]"
          />
        </div>

        {/* Footer */}
        <p className="text-center mt-8 text-gray-400 text-sm font-mono">
          PS: Hover highlighted keywords to decrypt
        </p>
      </motion.div>
    </div>
  );
