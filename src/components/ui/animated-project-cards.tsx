      ...
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-4 flex-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Price */}
            <motion.p className="flex text-md font-medium leading-tight tracking-tight md:text-lg transition-colors duration-200" variants={childVariants}>
                <motion.div className="flex items-center gap-3 mb-2" variants={childVariants}>
                    <span className="text-md font-medium leading-tight tracking-tight md:text-lg transition-colors duration-200">
